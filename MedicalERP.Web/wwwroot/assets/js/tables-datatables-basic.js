...
$(function () {
    var dt_basic_table = $('.datatables-role'),
    ...
    dt_basic_table.DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                targets: 6,
                render: function (data, type, full, meta) {
                    var status_number = data === 'Active' ? 1 : 2;
                    var status = {
        ...
        order: [[2, 'asc']], // Adjust the initial sorting to match your table structure
                ...
                buttons: [
                    {
                        ...
                        exportOptions: {
                            columns: ':not(:nth-child(1)):not(:last-child)',
